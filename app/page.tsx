  ...
  return (
    <main className="min-h-screen bg-[#080808] text-white overflow-x-hidden" style={{ fontFamily: 'var(--font-syne), sans-serif' }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-6">
        ...
        <a href="https://apps.apple.com" className="text-[10px] tracking-[0.35em] uppercase text-white/40 hover:text-white transition-colors duration-300">Download iOS</a>
      </nav>
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <h1
            ...
            style={{ fontSize: 'clamp(7rem, 23vw, 22rem)', letterSpacing: '-0.02em' }}
          >
            APEX
          </h1>
      ...
      <section className="py-28 border-y border-white/[0.06]">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4">
          {[
            { n: '350+', l: 'ROUTES',    border: 'border-r border-b border-white/[0.07] md:border-b-0' },
            { n: '7',    l: 'CITIES',    border: 'md:border-r border-b border-white/[0.07] md:border-b-0' },
            { n: '5',    l: 'TRIBES',    border: 'border-r border-white/[0.07]' },
            { n: '1',    l: 'COMMUNITY', border: '' },
          ].map((s) => (
            <div key={s.l} className={`flex flex-col items-start px-6 md:px-12 py-6 ${s.border}`}>
      ...
      <section className="py-24">
        ...
        <div className="flex flex-col md:flex-row w-full md:h-[70vh]">
          {TRIBES.map((t) => (
            <div key={t.name} className="relative h-[40vh] md:h-auto md:flex-1 overflow-hidden group cursor-pointer">
              <img
                src={t.img}
                alt={t.name}
      ...
      <section className="relative h-[50vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-6">
          <h2 className="font-extrabold text-white leading-none" style={{ fontSize: 'clamp(2.5rem, 7vw, 6rem)' }}>
            THE GCC DRIVES<br /><span className="text-[#C9A84C]">TOGETHER.</span>
          </h2>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 border-t border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          <h2 className="font-extrabold text-white leading-none mb-16 md:mb-20" style={{ fontSize: 'clamp(3rem, 9vw, 8rem)' }}>Your Access</h2>
          <div className="flex flex-col divide-y divide-white/[0.07]">
            ...
            <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-16 py-10 lg:py-14">
              ...
              <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-12 gap-y-4 pt-1">
              ...
              <a
                href="https://apps.apple.com"
                className="flex-shrink-0 lg:self-center px-8 py-3 border border-white/30 text-white/60 text-[10px] tracking-[0.3em] uppercase hover:border-white hover:text-white transition-all duration-300"
              >
                GET IGNITE
              </a>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-16 py-10 lg:py-14">
              ...
              <a
                href="https://apps.apple.com"
                className="flex-shrink-0 lg:self-center px-8 py-3 bg-[#C9A84C] text-black text-[10px] tracking-[0.3em] uppercase font-bold hover:bg-white transition-all duration-300"
              >
                GET CARBON
              </a>
            </div>
            ...
            {/* OBSIDIAN */}
            <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-16 py-10 lg:py-14 opacity-60">
              <div className="lg:w-48 flex-shrink-0">
              ...
              <div className="flex-shrink-0 lg:self-center px-8 py-3 border border-white/10 text-white/20 text-[10px] tracking-[0.3em] uppercase cursor-not-allowed">
                INVITATION ONLY
              </div>
            </div>
      ...
      <section className="relative py-52 overflow-hidden border-t border-white/[0.06]">
        ...
        <div className="relative z-10 text-center px-6">
          <h2 className="font-extrabold text-white leading-none" style={{ fontSize: 'clamp(3.5rem, 12vw, 11rem)' }}>
            THIS IS NOT<br /><span className="text-[#C9A84C]">FOR EVERYONE.</span>
          </h2>
      ...
      <footer className="py-10 border-t border-white/[0.05]">
        <div className="max-w-6xl mx-auto px-6 md:px-10 flex flex-col md:flex-row items-center justify-between gap-4">
          <span className="font-extrabold text-white/40 text-sm tracking-widest">APEX</span>
