    ...
    <main className="min-h-screen bg-[#080808] text-white overflow-x-hidden" style={{ fontFamily: 'var(--font-syne), sans-serif' }}>
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <h1 className="text-white font-extrabold leading-none select-none" style={{ fontSize: 'clamp(7rem, 23vw, 22rem)', letterSpacing: '-0.02em' }}>
            APEX
          </h1>
          ...
          {TRIBES.map((t) => (
            <div key={t.name} className="relative flex-1 overflow-hidden group cursor-pointer">
              ...
              <div className="absolute bottom-8 left-0 right-0 flex justify-center">
                <p className="font-extrabold text-white tracking-widest select-none" style={{ fontSize: 'clamp(0.65rem, 1.4vw, 1rem)', writingMode: 'vertical-rl', textOrientation: 'mixed', transform: 'rotate(180deg)', letterSpacing: '0.25em' }}>
                  {t.name}
                </p>
              </div>
            </div>
      ...
      <section className="py-32 border-t border-white/[0.06]">
        <div className="max-w-6xl mx-auto px-10">
          ...
          <div className="flex flex-col divide-y divide-white/[0.07]">
            ...
            <div className="flex items-start gap-16 py-14">
              ...
              <a href="https://apps.apple.com" className="flex-shrink-0 self-center px-8 py-3 border border-white/20 text-white/50 text-[10px] tracking-[0.3em] uppercase hover:border-white hover:text-white transition-all duration-300">GET IGNITE</a>
            </div>
            ...
            <div className="flex items-start gap-16 py-14">
              ...
              <a href="https://apps.apple.com" className="flex-shrink-0 self-center px-8 py-3 bg-[#C9A84C] text-black text-[10px] tracking-[0.3em] uppercase font-bold hover:bg-white transition-all duration-300">GET CARBON</a>
            </div>

            <div className="flex items-start gap-16 py-14 opacity-60">
              <div className="w-48 flex-shrink-0">
              ...
              <div className="flex-shrink-0 self-center px-8 py-3 border border-white/10 text-white/20 text-[10px] tracking-[0.3em] uppercase cursor-not-allowed">INVITATION ONLY</div>
            </div>
